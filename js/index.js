...
$(function() {
		...
		$(".rad-notification-item").on("click", function() {
				alert("hi");
		});
...
function drawD3Donut() {
		var w = $(".d3-donut").parent().width(),
				h = 400,
				r = 100,
		...
		//d3.select('.d3-donut').remove();
		var vis = d3.select(".d3-donut")
				.append("svg")
				.attr("width", w - 20)
				.attr("height", h - 20);
		...
		var donut = group.selectAll("path")
				.data(pie(data))
				.enter()
				.append("path")
		...
		var legends = d3.select(".d3-legends")
				.append("svg")
				.attr("width", 50)
				.attr("height", 50);
